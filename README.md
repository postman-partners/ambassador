# Ambassador
This is a shared GitHub repository for working with Datawire.io team on defining the API lifecycle using Postman and Ambasador.

I pulled the Swagger 2.0 for Kubernetes and converted to OpenAPI 3.0, then synced it with a Postman workspace I've setup for this partnership, and generated a Postman reference collection--which I have published here as well.
